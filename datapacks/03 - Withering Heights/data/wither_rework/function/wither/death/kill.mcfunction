...
summon item ~ ~2 ~ {NoGravity:1b,Item:{id:"minecraft:nether_star",components:{"minecraft:custom_data":{wr_nether_star:1b}}},PickupDelay:80,Glowing:1b,Motion:[0.0d,0.025d,0.0d]}
summon item ~ ~1 ~ {NoGravity:1b,Item:{id:"valcon:shard_of_sorrow"},PickupDelay:80,Glowing:1b,Motion:[0.0d,0.025d,0.0d]}
