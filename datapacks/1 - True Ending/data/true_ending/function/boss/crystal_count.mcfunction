...
execute if score crystals_left_pretick trueEnding_storage matches 1.. positioned 0 65 0 run title @a[distance=..128] actionbar [{"score":{"objective":"trueEnding_storage","name":"crystals_left"}},{"text":" Shadow Crystals Left"}]
execute if score crystals_left trueEnding_storage matches 0 if score crystals_left_pretick trueEnding_storage matches 1.. positioned 0 65 0 run title @a[distance=..128] actionbar [{"text":"All Shadow Crystals Destroyed!","color": "light_purple"}]
