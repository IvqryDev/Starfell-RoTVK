...
execute if score @s refresh_daycounter2 matches 100 if score day refresh_daycounter matches 100.. run scoreboard players operation multiple refresh_daycounter %= 100 refresh_constants
